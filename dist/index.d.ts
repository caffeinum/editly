...
type easings_EasingFunction = EasingFunction;
declare const easings_easeInOutCubic: typeof easeInOutCubic;
declare const easings_easeOutExpo: typeof easeOutExpo;
declare const easings_linear: typeof linear;
declare namespace easings {
  export {
    easings_easeInOutCubic as easeInOutCubic,
    easings_easeOutExpo as easeOutExpo,
    easings_linear as linear,
  };
  export type { easings_EasingFunction as EasingFunction };
}
...
declare class Transition {
  ...
  source?: GlTransition;
  constructor(options?: TransitionOptions | null, isLastClip?: boolean);
  create({
    width,
    height,
    channels,
    ...
    height: number;
    channels: number;
  }): ({ fromFrame, toFrame, progress }: RunTransitionOptions) => Buffer<ArrayBufferLike>;
}
...
interface RenderSingleFrameConfig extends ConfigurationOptions {
  /**
 ...
 */
declare function Editly(input: ConfigurationOptions): Promise<void>;
declare namespace Editly {
  var renderSingleFrame: typeof renderSingleFrame;
}
/**
 ...
 * @param config - ConfigurationOptions.
 */
declare function renderSingleFrame(input: RenderSingleFrameConfig): Promise<void>;

export { Editly as default, renderSingleFrame, Transition };
export type {
  AudioLayer,
  ...
  Clip,
  CurveType,
  CustomCanvasFunction,
  CustomCanvasFunctionArgs,
  CustomCanvasFunctionCallbacks,
  CustomFabricFunction,
  CustomFabricFunctionArgs,
  CustomFabricFunctionCallbacks,
  DefaultLayerOptions,
  DefaultLayerTypeOptions,
  DefaultOptions,
  DetachedAudioLayer,
  Easing,
  EditlyBannerLayer,
  ...
  TransitionType,
  VideoLayer,
  VideoPostProcessingFunctionArgs,
};
